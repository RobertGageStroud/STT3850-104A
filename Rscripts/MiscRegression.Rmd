...
## Base R Graph
The form of Figure \@ref(fig:base1)
is linear. 
...
```
```{r, label = "youchange", fig.width = 12, fig.height = 4, fig.cap = "Scatterplot of `sales` versus `TV`, `radio`, & `newspaper`"}
par(mfrow = c(1, 3))
plot(sales ~ TV, data = AD, col = "red", pch = 19)
mod1 <- lm(sales ~ TV, data = AD)
abline(mod1, col = "blue")
...
The form of the three graphs in Figure \@ref(fig:youchange) is linear.
